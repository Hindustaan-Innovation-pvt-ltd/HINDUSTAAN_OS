  ...
  const handleCreateTask = async (taskFields: any) => {
    try {
      ...
      const res = await api.post('/tasks', {
        ...
        assigneeIds: taskFields.assigneeIds || (taskFields.assigneeId ? [taskFields.assigneeId] : undefined),
        assigneeId: taskFields.assigneeId || (taskFields.assigneeIds?.[0] || undefined),
        priority: backendPriority,
