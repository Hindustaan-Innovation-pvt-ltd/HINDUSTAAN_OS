      ...
      <div className="relative z-10 flex w-full min-h-screen lg:h-screen lg:min-h-0 lg:max-h-screen lg:overflow-hidden">
        ...
        <div className="flex-1 flex items-center justify-center p-4 sm:p-6 lg:p-2 xl:p-12 w-full lg:w-[55%] xl:w-[50%] z-10 py-16 lg:py-2 lg:h-screen lg:overflow-hidden">
          <div className="w-full max-w-md">
            <div className="rounded-3xl border border-white/60 dark:border-slate-700/50 bg-white/70 dark:bg-slate-900/60 p-6 sm:p-8 lg:p-5 lg:py-2.5 xl:p-8 shadow-2xl backdrop-blur-xl transition-all duration-500 animate-in fade-in slide-in-from-bottom-8">
                      ...
                      <Controller
                        ...
                        render={({ field }) => (
                          <Select value={field.value} onValueChange={field.onChange}>
                            <SelectTrigger className="w-full rounded-xl border border-slate-200 dark:border-slate-700/50 bg-slate-50/50 dark:bg-slate-800/50 py-1 h-10.5 lg:h-8.5 pl-11 pr-4 text-sm text-slate-900 dark:text-white focus:ring-4 focus:ring-orange-500/10 dark:focus:ring-orange-500/20">
                  ...
                  <div className="space-y-1">
                    ...
                    <div className="relative group">
                      <Controller
                        ...
                        render={({ field }) => (
                          <Select value={field.value} onValueChange={field.onChange}>
                            <SelectTrigger className="w-full rounded-xl border border-slate-200 dark:border-slate-700/50 bg-slate-50/50 dark:bg-slate-800/50 py-1 h-10.5 lg:h-8.5 px-4 text-sm text-slate-900 dark:text-white focus:ring-4 focus:ring-orange-500/10 dark:focus:ring-orange-500/20">
                ...
                {selectedRole === 'employee' && (
                  <div className="space-y-1">
                    ...
                    <Controller
                      ...
                      render={({ field }) => (
                        <Select value={field.value} onValueChange={field.onChange}>
                          <SelectTrigger className="w-full rounded-xl border border-slate-200 dark:border-slate-700/50 bg-slate-50/50 dark:bg-slate-800/50 py-1 h-10.5 lg:h-8.5 px-4 text-sm text-slate-900 dark:text-white focus:ring-4 focus:ring-orange-500/10">
