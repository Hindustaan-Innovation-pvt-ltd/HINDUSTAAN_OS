...
import { exportSingleLeadDossierPDF } from '../utils/leadPdfExport';
              ...
              <DropdownMenu>
                <DropdownMenuTrigger asChild>
                  <Button
                    variant="outline"
                    size="sm"
                    className="h-8 px-2.5 text-xs gap-1.5 border-primary/30 text-primary hover:bg-primary/10 shadow-2xs font-medium"
                  >
                ...
                <DropdownMenuContent align="end" className="w-52 bg-card border-border shadow-lg">
                  <DropdownMenuItem
                    onClick={() => {
                      const res = exportSingleLeadDossierPDF(lead, 'print');
                  ...
                  >
                    ...
                    <div>
                      <p className="font-semibold text-foreground">Print Dossier</p>
                      <p className="text-[10px] text-muted-foreground">Opens browser print dialog</p>
                    </div>
                  </DropdownMenuItem>
                  <DropdownMenuItem
                    onClick={() => {
                      const res = exportSingleLeadDossierPDF(lead, 'download');
                  ...
                  >
                    ...
                    <div>
                      <p className="font-semibold text-foreground">Download PDF</p>
                      <p className="text-[10px] text-muted-foreground">Executive 1-page summary</p>
                    </div>
                  </DropdownMenuItem>
                </DropdownMenuContent>
              </DropdownMenu>
