        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-3">
          ...
          <div className="relative flex-1 max-w-md">
            ...
            <Input
              ...
              className="pl-9 pr-8 h-10 rounded-xl border-input bg-muted/40 text-foreground text-sm font-semibold"
            />
            {searchQuery && (
              <button
          ...
          <div className="flex items-center gap-2.5 flex-wrap w-full md:w-auto">
            ...
            >
              <SelectTrigger className="h-10 px-3 rounded-xl border-input bg-muted/40 text-xs font-bold text-foreground w-full sm:w-[130px]">
            ...
            {(user?.role === 'admin' || user?.role === 'manager') && (
              ...
              >
                <SelectTrigger className="h-10 px-3 rounded-xl border-input bg-muted/40 text-xs font-bold text-foreground w-full sm:w-[140px]">
            ...
            <Select
              value={dateFilter}
              onValueChange={(val) => { setDateFilter(val); setCurrentPage(1); }}
            >
              <SelectTrigger className="h-10 px-3 rounded-xl border-input bg-muted/40 text-xs font-bold text-foreground w-full sm:w-[130px]">
                    ...
                    >
                      ...
                      <TableCell className="px-3.5 py-3.5 whitespace-nowrap text-center">
                        {rec.latitude !== null && rec.latitude !== undefined && rec.longitude !== null && rec.longitude !== undefined ? (
                          ...
                          <div className="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-full text-[11px] font-medium bg-destructive/10 text-destructive border border-destructive/20">
                      ...
                      <TableCell className="px-3.5 py-3.5 whitespace-nowrap">
                        <div className="flex flex-col items-start gap-1">
                          ...
                          {isMissed && (
                            <p className="text-[10px] text-destructive max-w-xs truncate" title={rec.invalidReason || "Forgot to checkout within maximum working hours + 1 extra hour."}>
