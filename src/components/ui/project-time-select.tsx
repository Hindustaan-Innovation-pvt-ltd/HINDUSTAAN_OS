...
export function ProjectTimeSelect({
  ...
  return (
    <>
      ...
      <SelectContent className="rounded-2xl border border-purple-500/20 shadow-2xl backdrop-blur-md bg-slate-950 text-white max-h-[200px]">
        {Array.from({ length: 48 }).map((_, i) => {
          ...
          return (
            <SelectItem key={valueStr} value={valueStr} className="hover:bg-slate-800 focus:bg-slate-800 cursor-pointer">
              {timeStr}
            </SelectItem>
          );
        })}
